...
/*
	TODO :  A "storage" is a directory, we call that a node.
			A "storage" can be a directory (storage) or a file (stream).
*/
...
} __attribute__((packed)) cfbCLSID_t;
*/
...
} __attribute__((packed)) cfbFiletime_t;
*/
