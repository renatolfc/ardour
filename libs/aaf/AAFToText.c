...
const wchar_t * ParameterToText( AAF_Data *aafd, const aafUID_t *auid )
{
	...
	// if ( aafUIDCmp( auid, &PanVol_IsTrimGainEffect ) )
...
const wchar_t * ClassIDToText( AAF_Data *aafd, const aafUID_t *auid )
{
	...
	else if ( aafUIDCmp( auid, &AAFClassID_InterchangeObject ) )
		return L"AAFClassID_InterchangeObject";
	else if ( aafUIDCmp( auid, &AAFClassID_Component ) )
		return L"AAFClassID_Component";
	else if ( aafUIDCmp( auid, &AAFClassID_Segment ) )
		return L"AAFClassID_Segment";
	else if ( aafUIDCmp( auid, &AAFClassID_EdgeCode ) )
		return L"AAFClassID_EdgeCode";
	else if ( aafUIDCmp( auid, &AAFClassID_EssenceGroup ) )
		return L"AAFClassID_EssenceGroup";
	else if ( aafUIDCmp( auid, &AAFClassID_Event ) )
		return L"AAFClassID_Event";
	else if ( aafUIDCmp( auid, &AAFClassID_GPITrigger ) )
		return L"AAFClassID_GPITrigger";
	else if ( aafUIDCmp( auid, &AAFClassID_CommentMarker ) )
		return L"AAFClassID_CommentMarker";
	else if ( aafUIDCmp( auid, &AAFClassID_Filler ) )
		return L"AAFClassID_Filler";
	else if ( aafUIDCmp( auid, &AAFClassID_OperationGroup ) )
		return L"AAFClassID_OperationGroup";
	else if ( aafUIDCmp( auid, &AAFClassID_NestedScope ) )
		return L"AAFClassID_NestedScope";
	else if ( aafUIDCmp( auid, &AAFClassID_Pulldown ) )
		return L"AAFClassID_Pulldown";
	else if ( aafUIDCmp( auid, &AAFClassID_ScopeReference ) )
		return L"AAFClassID_ScopeReference";
	else if ( aafUIDCmp( auid, &AAFClassID_Selector ) )
		return L"AAFClassID_Selector";
	else if ( aafUIDCmp( auid, &AAFClassID_Sequence ) )
		return L"AAFClassID_Sequence";
	else if ( aafUIDCmp( auid, &AAFClassID_SourceReference ) )
		return L"AAFClassID_SourceReference";
	else if ( aafUIDCmp( auid, &AAFClassID_SourceClip ) )
		return L"AAFClassID_SourceClip";
	else if ( aafUIDCmp( auid, &AAFClassID_TextClip ) )
		return L"AAFClassID_TextClip";
	else if ( aafUIDCmp( auid, &AAFClassID_HTMLClip ) )
		return L"AAFClassID_HTMLClip";
	else if ( aafUIDCmp( auid, &AAFClassID_Timecode ) )
		return L"AAFClassID_Timecode";
	else if ( aafUIDCmp( auid, &AAFClassID_TimecodeStream ) )
		return L"AAFClassID_TimecodeStream";
	else if ( aafUIDCmp( auid, &AAFClassID_TimecodeStream12M ) )
		return L"AAFClassID_TimecodeStream12M";
	else if ( aafUIDCmp( auid, &AAFClassID_Transition ) )
		return L"AAFClassID_Transition";
	else if ( aafUIDCmp( auid, &AAFClassID_ContentStorage ) )
		return L"AAFClassID_ContentStorage";
	else if ( aafUIDCmp( auid, &AAFClassID_ControlPoint ) )
		return L"AAFClassID_ControlPoint";
	else if ( aafUIDCmp( auid, &AAFClassID_DefinitionObject ) )
		return L"AAFClassID_DefinitionObject";
	else if ( aafUIDCmp( auid, &AAFClassID_DataDefinition ) )
		return L"AAFClassID_DataDefinition";
	else if ( aafUIDCmp( auid, &AAFClassID_OperationDefinition ) )
		return L"AAFClassID_OperationDefinition";
	else if ( aafUIDCmp( auid, &AAFClassID_ParameterDefinition ) )
		return L"AAFClassID_ParameterDefinition";
	else if ( aafUIDCmp( auid, &AAFClassID_PluginDefinition ) )
		return L"AAFClassID_PluginDefinition";
	else if ( aafUIDCmp( auid, &AAFClassID_CodecDefinition ) )
		return L"AAFClassID_CodecDefinition";
	else if ( aafUIDCmp( auid, &AAFClassID_ContainerDefinition ) )
		return L"AAFClassID_ContainerDefinition";
	else if ( aafUIDCmp( auid, &AAFClassID_InterpolationDefinition ) )
		return L"AAFClassID_InterpolationDefinition";
	else if ( aafUIDCmp( auid, &AAFClassID_Dictionary ) )
		return L"AAFClassID_Dictionary";
	else if ( aafUIDCmp( auid, &AAFClassID_EssenceData ) )
		return L"AAFClassID_EssenceData";
	else if ( aafUIDCmp( auid, &AAFClassID_EssenceDescriptor ) )
		return L"AAFClassID_EssenceDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_FileDescriptor ) )
		return L"AAFClassID_FileDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_AIFCDescriptor ) )
		return L"AAFClassID_AIFCDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_DigitalImageDescriptor ) )
		return L"AAFClassID_DigitalImageDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_CDCIDescriptor ) )
		return L"AAFClassID_CDCIDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_RGBADescriptor ) )
		return L"AAFClassID_RGBADescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_HTMLDescriptor ) )
		return L"AAFClassID_HTMLDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_TIFFDescriptor ) )
		return L"AAFClassID_TIFFDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_WAVEDescriptor ) )
		return L"AAFClassID_WAVEDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_FilmDescriptor ) )
		return L"AAFClassID_FilmDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_TapeDescriptor ) )
		return L"AAFClassID_TapeDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_Header ) )
		return L"AAFClassID_Header";
	else if ( aafUIDCmp( auid, &AAFClassID_Identification ) )
		return L"AAFClassID_Identification";
	else if ( aafUIDCmp( auid, &AAFClassID_Locator ) )
		return L"AAFClassID_Locator";
	else if ( aafUIDCmp( auid, &AAFClassID_NetworkLocator ) )
		return L"AAFClassID_NetworkLocator";
	else if ( aafUIDCmp( auid, &AAFClassID_TextLocator ) )
		return L"AAFClassID_TextLocator";
	else if ( aafUIDCmp( auid, &AAFClassID_Mob ) )
		return L"AAFClassID_Mob";
	else if ( aafUIDCmp( auid, &AAFClassID_CompositionMob ) )
		return L"AAFClassID_CompositionMob";
	else if ( aafUIDCmp( auid, &AAFClassID_MasterMob ) )
		return L"AAFClassID_MasterMob";
	else if ( aafUIDCmp( auid, &AAFClassID_SourceMob ) )
		return L"AAFClassID_SourceMob";
	else if ( aafUIDCmp( auid, &AAFClassID_MobSlot ) )
		return L"AAFClassID_MobSlot";
	else if ( aafUIDCmp( auid, &AAFClassID_EventMobSlot ) )
		return L"AAFClassID_EventMobSlot";
	else if ( aafUIDCmp( auid, &AAFClassID_StaticMobSlot ) )
		return L"AAFClassID_StaticMobSlot";
	else if ( aafUIDCmp( auid, &AAFClassID_TimelineMobSlot ) )
		return L"AAFClassID_TimelineMobSlot";
	else if ( aafUIDCmp( auid, &AAFClassID_Parameter ) )
		return L"AAFClassID_Parameter";
	else if ( aafUIDCmp( auid, &AAFClassID_ConstantValue ) )
		return L"AAFClassID_ConstantValue";
	else if ( aafUIDCmp( auid, &AAFClassID_VaryingValue ) )
		return L"AAFClassID_VaryingValue";
	else if ( aafUIDCmp( auid, &AAFClassID_TaggedValue ) )
		return L"AAFClassID_TaggedValue";
	else if ( aafUIDCmp( auid, &AAFClassID_KLVData ) )
		return L"AAFClassID_KLVData";
	else if ( aafUIDCmp( auid, &AAFClassID_DescriptiveMarker ) )
		return L"AAFClassID_DescriptiveMarker";
	else if ( aafUIDCmp( auid, &AAFClassID_SoundDescriptor ) )
		return L"AAFClassID_SoundDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_DataEssenceDescriptor ) )
		return L"AAFClassID_DataEssenceDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_MultipleDescriptor ) )
		return L"AAFClassID_MultipleDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_DescriptiveClip ) )
		return L"AAFClassID_DescriptiveClip";
	else if ( aafUIDCmp( auid, &AAFClassID_AES3PCMDescriptor ) )
		return L"AAFClassID_AES3PCMDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_PCMDescriptor ) )
		return L"AAFClassID_PCMDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_PhysicalDescriptor ) )
		return L"AAFClassID_PhysicalDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_ImportDescriptor ) )
		return L"AAFClassID_ImportDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_RecordingDescriptor ) )
		return L"AAFClassID_RecordingDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_TaggedValueDefinition ) )
		return L"AAFClassID_TaggedValueDefinition";
	else if ( aafUIDCmp( auid, &AAFClassID_KLVDataDefinition ) )
		return L"AAFClassID_KLVDataDefinition";
	else if ( aafUIDCmp( auid, &AAFClassID_AuxiliaryDescriptor ) )
		return L"AAFClassID_AuxiliaryDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_RIFFChunk ) )
		return L"AAFClassID_RIFFChunk";
	else if ( aafUIDCmp( auid, &AAFClassID_BWFImportDescriptor ) )
		return L"AAFClassID_BWFImportDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_MPEGVideoDescriptor ) )
		return L"AAFClassID_MPEGVideoDescriptor";
	else if ( aafUIDCmp( auid, &AAFClassID_ClassDefinition ) )
		return L"AAFClassID_ClassDefinition";
	else if ( aafUIDCmp( auid, &AAFClassID_PropertyDefinition ) )
		return L"AAFClassID_PropertyDefinition";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinition ) )
		return L"AAFClassID_TypeDefinition";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinitionInteger ) )
		return L"AAFClassID_TypeDefinitionInteger";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinitionStrongObjectReference ) )
		return L"AAFClassID_TypeDefinitionStrongObjectReference";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinitionWeakObjectReference ) )
		return L"AAFClassID_TypeDefinitionWeakObjectReference";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinitionEnumeration ) )
		return L"AAFClassID_TypeDefinitionEnumeration";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinitionFixedArray ) )
		return L"AAFClassID_TypeDefinitionFixedArray";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinitionVariableArray ) )
		return L"AAFClassID_TypeDefinitionVariableArray";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinitionSet ) )
		return L"AAFClassID_TypeDefinitionSet";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinitionString ) )
		return L"AAFClassID_TypeDefinitionString";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinitionStream ) )
		return L"AAFClassID_TypeDefinitionStream";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinitionRecord ) )
		return L"AAFClassID_TypeDefinitionRecord";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinitionRename ) )
		return L"AAFClassID_TypeDefinitionRename";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinitionExtendibleEnumeration ) )
		return L"AAFClassID_TypeDefinitionExtendibleEnumeration";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinitionIndirect ) )
		return L"AAFClassID_TypeDefinitionIndirect";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinitionOpaque ) )
		return L"AAFClassID_TypeDefinitionOpaque";
	else if ( aafUIDCmp( auid, &AAFClassID_TypeDefinitionCharacter ) )
		return L"AAFClassID_TypeDefinitionCharacter";
	else if ( aafUIDCmp( auid, &AAFClassID_MetaDefinition ) )
		return L"AAFClassID_MetaDefinition";
	else if ( aafUIDCmp( auid, &AAFClassID_MetaDictionary ) )
		return L"AAFClassID_MetaDictionary";
	else if ( aafUIDCmp( auid, &AAFClassID_DescriptiveObject ) )
		return L"AAFClassID_DescriptiveObject";
	else if ( aafUIDCmp( auid, &AAFClassID_DescriptiveFramework ) )
